...
struct ret_val_mem asm_main6(void *heap, int64_t input1, int64_t input2, int64_t input3, int64_t input4, int64_t input5, int64_t input6);
struct ret_val_mem asm_main7(void *heap, int64_t input1, int64_t input2, int64_t input3, int64_t input4, int64_t input5, int64_t input6, int64_t input7);
...
int main(int argc, char *argv[]) {
  ...
  switch (argc) {
    ...
    case 7:
      ...
      input5 = atoi(argv[5]);
      input6 = atoi(argv[6]);
      val_mem = asm_main6(heap, input1, input2, input3, input4, input5, input6);
      break;
    case 8:
      input1 = atoi(argv[1]);
      input2 = atoi(argv[2]);
      ...
      input6 = atoi(argv[6]);
      input7 = atoi(argv[7]);
      val_mem = asm_main7(heap, input1, input2, input3, input4, input5, input6, input7);
      break;
    default:
