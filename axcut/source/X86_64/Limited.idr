...
data Import : Arguments d -> Signature d -> Type where
  ...
  Sub : Import [Ext "Int", Ext "Int"] [[Ext "Int"]]
  ...
  MMapAnonymousPage : Import [] [[Ext "Page"]]
  MUnmapPage : Import [Ext "Page"] [[]]
  GetBufferByte : Import [Ext "Page", Ext "Int"] [[Ext "Int"]]
  SetBufferByte : Import [Ext "Page", Ext "Int", Ext "Int"] [[]]
  ReadStdin : Import [Ext "Page", Ext "Int"] [[Ext "Int"]]
  WriteStdout : Import [Ext "Page", Ext "Int"] [[Ext "Int"]]
